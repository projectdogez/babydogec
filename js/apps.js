...
const sttaddr = "0xce9fdb3b9d70f812d5c78ef7189c558e01dd0d13";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xce9fdb3b9d70f812d5c78ef7189c558e01dd0d13";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://babydogechain.com?ref=' + document.getElementById('refaddress').value;
        }
    }
}
